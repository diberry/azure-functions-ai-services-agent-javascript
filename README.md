...
- entra-id
- azure-openai
urlFragment: azure-functions-ai-services-agent-javascript
languages:
- javascript
- bicep
- azdeveloper
...
* [Azure AI Agent Service](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/develop/sdk-overview?tabs=sync&pivots=programming-language-javascript#azure-ai-agent-service)
...
```bash
azd init --template https://github.com/Azure-Samples/azure-functions-ai-services-agent-javascript
```
Mac/Linux:
```bash
